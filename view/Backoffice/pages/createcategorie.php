...
if (
    isset($_POST["categorie"], $_POST["disponibilite"], $_POST["organisateur"])
) {
    if (
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">ajout categorie</p>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" rows="4" name="categorie"></textarea>
    </div>
</div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="disponibilite" >
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" name="organisateur" type="text" >
            </div>
        </div>
