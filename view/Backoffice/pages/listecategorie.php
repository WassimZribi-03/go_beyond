  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/listecategorie.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="col-12">
          ...
          <div class="card-header pb-0">
            <div class="d-flex align-items-center">
                ...
                <a href="createcategorie.php" class="btn btn-light btn-sm ">Add categorie</a>
              </div>
            </div>
...
<tr>   
    ...
    <td class="align-middle">
        <a href="editcategorie.php?id=<?php echo $categorie['id_categ']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
            Edit
        </a>
        <a href="deletecategorie.php?id=<?php echo $categorie['id_categ']; ?>" class="text-secondary font-weight-bold text-xs ms-2" data-toggle="tooltip" data-original-title="Delete user">
            Delete
        </a>
    </td>
</tr>
