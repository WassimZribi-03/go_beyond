        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="d-flex align-items-center">
                ...
                <button class="btn btn-primary btn-sm ms-auto" onclick="window.location.href='addguide.php';">Add Guide</button>
              </div>
            </div>
...
<th class="text-secondary opacity-7"></th>
        ...
        ?> <tr>
         <td class="align-middle text-center text-sm"><?= $guide['id']; ?></td>
<td class="align-middle  text-sm"><?= $guide['title']; ?></td>

<td class="align-middle  text-sm"><?= $guide['language']; ?></td>

<td class="align-middle  text-sm"><?= $guide['price']; ?></td>
<td class="align-middle  text-sm"><?= $guide['category']; ?></td>
