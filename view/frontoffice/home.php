...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <p>categories</p>
         <div class="flex-box">
            <a href="category.php?category=Destinations" class="links">Destinations</a>
            <a href="category.php?category=Astuces et Conseils de Voyage" class="links">Astuces et Conseils de Voyage</a>
            <a href="category.php?category=Expériences Client" class="links">Expériences Client</a>
            <a href="category.php?category=Guides Pratiques" class="links">Guides Pratiques</a>
            <a href="category.php?category=Offres et Promotions" class="links">Offres et Promotions</a>
            <a href="category.php?category=Culture et Traditions" class="links">Culture et Traditions</a>
            <a href="category.php?category=Voyages de Luxe" class="links">Voyages de Luxe</a>
            <a href="category.php?category=Voyages en Famille" class="links">Voyages en Famille</a>
            <a href="category.php?category=Voyages de Groupe" class="links">Voyages de Groupe</a>
            <a href="category.php?category=Voyages Gastronomiques" class="links">Voyages Gastronomiques</a>
