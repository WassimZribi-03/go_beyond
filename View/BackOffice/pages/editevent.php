...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" rows="4" name="description"><?php echo $event['description']; ?></textarea>
    </div>
</div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="capacity" value="<?php echo $event['capacity'] ?>">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" name="price" type="text" value="<?php echo $event['price'] ?>">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="example-text-input" class="form-control-label">date_start</label>
                <input class="form-control" name="date_start" type="text" value="<?php echo $event['date_start'] ?>">
            </div>
        </div>
    ...
    <div class='row'>  <div class="col-md-4">
            <div class="form-group">
                ...
                <input class="form-control" name="place" type="text" value="<?php echo $event['place'] ?>">
            </div>
        </div><div class="col-md-4">
            <div class="form-group">
                <label for="example-text-input" class="form-control-label">id</label>
                <input class="form-control" name="id" type="text" value="<?php echo $event['id'] ?>">
            </div>
