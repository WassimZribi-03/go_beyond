        ...
        <div class="col-12">
          ...
          <div class="card-header pb-0">
            <div class="d-flex justify-content-between">
                ...
                <a href="createevent.php" class="btn btn-primary btn-sm ">Add event</a>
              </div>
            </div>
...
<tr>   
    ...
    <td class="align-middle">
        <a href="editevent.php?id=<?php echo $event['id']; ?>" class="text-primary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
            Edit
        </a>
        <a href="deleteevent.php?id=<?php echo $event['id']; ?>" class="text-danger font-weight-bold text-xs ms-2" data-toggle="tooltip" data-original-title="Delete user">
            Delete
        </a>
    </td>
</tr>
