...
<html lang="en">
  ...
  <body>
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <a href="index.html">
                <img src="images/logoo.png"  alt="logo" class="img-fluid">
              </a>
            </div>
    ...
    <section style="background-image: url('images/images\ \(1\).jpg');background-repeat: no-repeat;background-size: cover; color: #fff;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-warning">Discover</span> Tunisia's <span class="fw-bold">Rich Culture</span></h2>
            <p class="fs-4">Uncover breathtaking destinations and experience unique traditions.</p>
            <div class="d-flex gap-3">
              <a href="#" class="btn btn-warning text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Explore Destinations</a>
              <a href="#" class="btn btn-light text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Plan Your Trip</a>
            </div>
          </div>
        </div>
        
        <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-3 g-0 justify-content-center mt-4">
          <div class="col">
            <div class="card border-0 bg-warning rounded-0 p-4 text-dark">
              <div class="row">
                <div class="col-md-3 text-center">
                  <svg width="60" height="60"><use xlink:href="#destinations"></use></svg>
                </div>
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-dark">Top Destinations</h5>
                    <p class="card-text">Explore Tunisia’s stunning landmarks and natural beauty.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-light rounded-0 p-4 text-dark">
              <div class="row">
                <div class="col-md-3 text-center">
                  <svg width="60" height="60"><use xlink:href="#heritage"></use></svg>
                </div>
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-dark">Cultural Heritage</h5>
                    <p class="card-text">Immerse yourself in Tunisia’s history and traditions.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-danger rounded-0 p-4 text-light">
              <div class="row">
                <div class="col-md-3 text-center">
                  <svg width="60" height="60"><use xlink:href="#travel"></use></svg>
                </div>
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Tailored Experiences</h5>
                    <p class="card-text">Plan custom tours for an unforgettable journey.</p>
                  </div>
                </div>
              </div>
            </div>
...
?>
    <div class="row">
        <div class="col-md-12">
            <div class="section-header d-flex flex-wrap justify-content-between my-4">
                <h2 class="section-title"><?php echo htmlspecialchars($guide['title']); ?></h2>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <div class="card" style="width: 100%; box-shadow: 2px 2px 5px rgba(0,0,0,0.1); border-radius: 8px; padding: 10px;">
                    <div class="text-center" style="margin-bottom: 10px;">
                        <!-- SVG Icon Placeholder -->
                        <div style="font-size: 50px; color: #555;">👤</div>
                    </div>
                    <div class="text-center" style="padding: 5px;">
                        <h5 style="font-size: 16px; font-weight: bold;"><?php echo htmlspecialchars($guide['title']); ?></h5>
                        <p style="font-size: 14px; color: #555;"><?php echo htmlspecialchars($guide['description']); ?></p>
                        <p style="margin: 2px 0; font-size: 14px;"><strong>Language:</strong> <?php echo htmlspecialchars($guide['language']); ?></p>
                        <p style="margin: 2px 0; font-size: 14px;"><strong>Region:</strong> <?php echo htmlspecialchars($guide['region']); ?></p>
                        <p style="margin: 2px 0; font-size: 14px; color: green;"><strong>Price:</strong> <?php echo htmlspecialchars($guide['price']); ?> TND</p>
                    </div>
                </div>
            </div>

            <!-- Disponibility and Reserve -->
            <div class="col-md-6 mb-3">
                <div class="card" style="width: 100%; box-shadow: 2px 2px 5px rgba(0,0,0,0.1); border-radius: 8px; padding: 10px;">
                    <div class="text-center" style="margin-bottom: 10px;">
                        <h5 style="font-size: 16px; font-weight: bold;">Choose Disponibility</h5>
                    </div>
    ...
    <?php foreach ($dispo as $availability) { ?>
        <label class="card availability-option" 
               style="cursor: pointer; padding: 10px; border: 1px solid #ddd; border-radius: 8px; text-align: center;">
...
?>
    ...
    <section>
      <div class="container-lg">
        <div class="bg-secondary text-light py-5 my-5" style="background: url('images/images\ \(1\).jpg') no-repeat; background-size: cover;">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-5 p-3">
                <div class="section-header">
                  <h2 class="section-title display-5 text-light">Sign Up for Exclusive Travel Tips</h2>
                </div>
                <p>Join our newsletter to receive travel tips, destination guides, and exclusive discounts on your next adventure.</p>
              </div>
              <div class="col-md-5 p-3">
                <form>
                  <div class="mb-3">
                    ...
                    <input type="text"
                      class="form-control form-control-md rounded-0" name="name" id="name" placeholder="Your Name">
                  </div>
                  <div class="mb-3">
                    <label for="email" class="form-label d-none">Email</label>
                    <input type="email" class="form-control form-control-md rounded-0" name="email" id="email" placeholder="Your Email Address">
                  </div>
                  <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-warning btn-md rounded-0">Subscribe Now</button>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="images/logoo.png" width="240" height="70" alt="logo">
