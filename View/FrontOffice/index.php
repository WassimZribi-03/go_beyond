    ...
    <div class="row">
      <div class="col-md-12">
        <div class="section-header d-flex flex-wrap justify-content-between my-4">
          <h2 class="section-title">Guide List</h2>
        </div>
      </div>
    </div>
    ...
    <div class="container my-4">
      <div id="guideList" class="d-flex flex-wrap gap-3"> <!-- Guide List Container -->
        <?php foreach ($list as $guide) { ?>
          <div class="guide-item card" style="width: 230px;" 
               data-name="<?php echo htmlspecialchars($guide['title']); ?>" 
               data-language="<?php echo htmlspecialchars($guide['language']); ?>" 
               data-region="<?php echo htmlspecialchars($guide['region']); ?>">
            <div class="text-center fs-1">
              <div style="font-size: 50px; color: #555;">👤</div>
            </div>
            <div class="d-flex flex-column text-center p-2">
              <h4 class="fs-6 fw-normal"><?php echo htmlspecialchars($guide['title']); ?></h4>
              <span class="fs-7"><?php echo htmlspecialchars($guide['language']); ?></span>
              <span class="fs-7 fw-bolder"><?php echo htmlspecialchars($guide['price']); ?> TND</span>
              <div class="mt-2">
                <a href="guide_details.php?id=<?php echo $guide['id']; ?>" class="btn btn-secondary btn-sm">View Details</a>
              </div>
            </div>
          </div>
        <?php } ?>
